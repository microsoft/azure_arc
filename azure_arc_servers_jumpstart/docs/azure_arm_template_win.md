...
2. The ARM template includes an Azure VM Custom Script Extension which will deploy the the [*install_arc_agent.ps1*](../azure/windows/arm_template/scripts/install_arc_agent.ps1) PowerShell Script.
...
* Once Azure resources have been provisioned, you will be able to see it in Azure portal.
    ...
    ![Screenshot ARM template output](../img/azure_arm_template_win/01.jpg)
...
* Now that the Windows Server VM is created, it is time to login to it. Using its public IP, RDP to the VM.
    ...
    ![Screenshot public IP address of the Azure Arc enabled server](../img/azure_arm_template_win/03.jpg)
...
![Screenshot PowerShell script output](../img/azure_arm_template_win/04.jpg)

![Screenshot PowerShell script output](../img/azure_arm_template_win/05.jpg)

![Screenshot PowerShell script output](../img/azure_arm_template_win/06.jpg)

![Screenshot PowerShell script output](../img/azure_arm_template_win/07.jpg)

* Upon successful run, a new Azure Arc enabled server will be added to the resource group.

    ![Screenshot Azure Arc enabled server in resource group](../img/azure_arm_template_win/08.jpg)
...
![Screenshot delete resource group](../img/azure_arm_template_win/10.jpg)
