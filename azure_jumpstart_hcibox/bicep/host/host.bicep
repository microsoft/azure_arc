...
resource vm 'Microsoft.Compute/virtualMachines@2022-03-01' = {
  ...
  properties: {
    hardwareProfile: {
      vmSize: deploySQLMI == true ? 'Standard_E32as_v5' : 'Standard_D48s_v5'
    }
    storageProfile: {
      osDisk: {
        name: '${vmName}-OSDisk'
