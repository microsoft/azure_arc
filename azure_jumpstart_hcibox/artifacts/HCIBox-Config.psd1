@{
    ...
    NestedVMMemoryinGB                   = 100GB                                 # This value controls the amount of RAM for each Nested Hyper-V Host (AzSHOST1-2).
    ...
    S2D_Disk_Size                        = 400GB                                   # Disk size for each of the 4 dynamic VHD disks attached to the 3 AzSHOST VMs that will be used to create the SDNCLUSTER
