...
azcopy cp 'https://jumpstartprodsg.blob.core.windows.net/hcibox/preprod/AzLocal2411.vhdx' "$($HCIBoxConfig.Paths.VHDDir)\AZSHCI.vhdx" --recursive=true --check-length=false --log-level=ERROR
