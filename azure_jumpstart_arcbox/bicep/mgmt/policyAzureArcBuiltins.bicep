...
var policyNameForLinuxDeployLogAnalytics_var = '(Hybrid ESLZ Sandbox) Deploy Linux Log Analytics agents'
var policyNameForWindowsDeployLogAnalytics_var = '(Hybrid ESLZ Sandbox) Deploy Windows Log Analytics agents'
var policyNameForLinuxDeployDependencyAgent_var = '(Hybrid ESLZ Sandbox) Deploy Linux Dependency Agents'
var policyNameForWindowsDeployDependencyAgent_var = '(Hybrid ESLZ Sandbox) Deploy Windows Dependency Agents'
var policyNameForAddResourceTag_var = '(Hybrid ESLZ Sandbox) Tag resources'
var policyNameForEnableAzureDefenderKubernetes_var = '(Hybrid ESLZ Sandbox) Enable Azure Defender on Kubernetes clusters'
...
resource policyNameForLinuxDeployLogAnalytics 'Microsoft.Authorization/policyAssignments@2019-09-01' = {
...
resource policyNameForWindowsDeployLogAnalytics 'Microsoft.Authorization/policyAssignments@2019-09-01' = {
...
resource policyNameForLinuxDeployDependencyAgent 'Microsoft.Authorization/policyAssignments@2019-09-01' = {
...
resource policyNameForWindowsDeployDependencyAgent 'Microsoft.Authorization/policyAssignments@2019-09-01' = {
...
resource policyNameForAddResourceTag 'Microsoft.Authorization/policyAssignments@2019-09-01' = {
...
resource policyNameForEnableAzureDefenderKubernetes 'Microsoft.Authorization/policyAssignments@2019-09-01' = {
