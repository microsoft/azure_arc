...
resource vm 'Microsoft.Compute/virtualMachines@2022-03-01' = {
  ...
  properties: {
    hardwareProfile: {
      vmSize: flavor == 'DevOps' ? 'Standard_B4ms' : flavor == 'DataOps' ? 'Standard_D4s_v4' : 'Standard_D16s_v4'
    }
    storageProfile: {
      osDisk: {
        name: '${vmName}-OSDisk'
