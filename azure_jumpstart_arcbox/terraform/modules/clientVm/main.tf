...
resource "azurerm_virtual_machine" "client" {
  ...
  network_interface_ids = [ azurerm_network_interface.nic.id ]
    vm_size             = var.deployment_flavor == "DevOps" ? "Standard_B4ms" : var.deployment_flavor == "DataOps" ? "Standard_D4s_v4" : "Standard_D16s_v4"
