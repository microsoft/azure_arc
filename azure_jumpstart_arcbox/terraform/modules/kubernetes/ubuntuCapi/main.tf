  ...
  protected_settings = <<PROTECTED_SETTINGS
    {
      ...
      "commandToExecute": "bash installCAPI.sh ${var.admin_username} ${var.spn_client_id} ${var.spn_client_secret} ${var.spn_tenant_id} ${var.vm_name} ${data.azurerm_resource_group.rg.name} ${data.azurerm_resource_group.rg.location} ${var.storage_account_name} ${var.workspace_name} ${var.capiArcDataClusterName} ${var.template_base_url}"
    }
PROTECTED_SETTINGS
}
