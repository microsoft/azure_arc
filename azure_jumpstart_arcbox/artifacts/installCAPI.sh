...
sed -i -e "$line"' i\      - name: capi-subnet-node' $CAPI_WORKLOAD_CLUSTER_NAME.yaml
...
sed -i -e "$line"' i\              priority: 2201' $CAPI_WORKLOAD_CLUSTER_NAME.yaml
...
sed -i -e "$line"' i\          name: my-subnet-cp-nsg' $CAPI_WORKLOAD_CLUSTER_NAME.yaml
...
sed -i -e "$line"' i\      - name: capi-subnet-cp' $CAPI_WORKLOAD_CLUSTER_NAME.yaml
