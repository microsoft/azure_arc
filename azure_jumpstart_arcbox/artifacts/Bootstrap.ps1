...
workflow ClientTools_01
        {
            ...
            Invoke-WebRequest ($templateBaseUrl + "../automated_testing/ghaction_scripts/GHActionDeploy.ps1") -OutFile "C:\ArcBox\GHActionDeploy.ps1"
            Invoke-WebRequest ($templateBaseUrl + "../automated_testing/ghaction_scripts/OpenSSHDeploy.ps1") -OutFile "C:\ArcBox\OpenSSHDeploy.ps1"
