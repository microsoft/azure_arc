            ...
            Parallel 
                {
                    ...
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/arcbox_connectedmode/azure_jumpstart_arcbox/artifacts/settingsTemplate.json" -OutFile "C:\ArcBox\settingsTemplate.json"
                    Invoke-WebRequest "https://aka.ms/azdata-msi" -OutFile "C:\ArcBox\AZDataCLI.msi"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/arcbox_connectedmode/azure_jumpstart_arcbox/artifacts/ArcServersLogonScript.ps1" -OutFile "C:\ArcBox\ArcServersLogonScript.ps1"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/arcbox_connectedmode/azure_jumpstart_arcbox/artifacts/DataServicesLogonScript.ps1" -OutFile "C:\ArcBox\DataServicesLogonScript.ps1"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/arcbox_connectedmode/azure_jumpstart_arcbox/artifacts/installArcAgent.ps1" -OutFile "C:\ArcBox\agentScript\installArcAgent.ps1"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/arcbox_connectedmode/azure_jumpstart_arcbox/artifacts/installArcAgentSQL.ps1" -OutFile "C:\ArcBox\agentScript\installArcAgentSQL.ps1"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/arcbox_connectedmode/azure_jumpstart_arcbox/artifacts/installArcAgent.sh" -OutFile "C:\ArcBox\agentScript\installArcAgent.sh"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/arcbox_connectedmode/azure_jumpstart_arcbox/artifacts/capiStorageClass.yaml" -OutFile "C:\ArcBox\capiStorageClass.yaml"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/arcbox_connectedmode/azure_jumpstart_arcbox/artifacts/DeployPostgreSQL.ps1" -OutFile "C:\ArcBox\DeployPostgreSQL.ps1"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/arcbox_connectedmode/azure_jumpstart_arcbox/artifacts/DeploySQLMI.ps1" -OutFile "C:\ArcBox\DeploySQLMI.ps1"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/arcbox_connectedmode/azure_jumpstart_arcbox/artifacts/dataController.json" -OutFile "C:\ArcBox\dataController.json"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/arcbox_connectedmode/azure_jumpstart_arcbox/artifacts/dataController.parameters.json" -OutFile "C:\ArcBox\dataController.parameters.json"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/arcbox_connectedmode/azure_jumpstart_arcbox/artifacts/postgreSQL.json" -OutFile "C:\ArcBox\postgreSQL.json"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/arcbox_connectedmode/azure_jumpstart_arcbox/artifacts/postgreSQL.parameters.json" -OutFile "C:\ArcBox\postgreSQL.parameters.json"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/arcbox_connectedmode/azure_jumpstart_arcbox/artifacts/sqlmi.json" -OutFile "C:\ArcBox\sqlmi.json"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/arcbox_connectedmode/azure_jumpstart_arcbox/artifacts/sqlmi.parameters.json" -OutFile "C:\ArcBox\sqlmi.parameters.json"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/arcbox_connectedmode/azure_jumpstart_arcbox/artifacts/wallpaper.png" -OutFile "C:\ArcBox\wallpaper.png"
                }
        }
