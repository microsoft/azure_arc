...
if ($flavor -eq "Full" -Or $flavor -eq "Developer") {
    if ( $arcNumResources -eq 11 )
    {
        ...
        az storage message put --content "Successful Jumpstart ArcBox ($flavor) deployment" --account-name "jumpstartusage" --queue-name "arcboxusage" --sas-token "?sv=2020-08-04&ss=q&srt=sco&sp=wa&se=2031-11-01T07:34:50Z&st=2021-10-18T23:34:50Z&spr=https&sig=tQMbCj5EthrwachHMuzLSJ4SgSOtEqqWcAbid6b87vU%3D" --time-to-live -1
    }
}
