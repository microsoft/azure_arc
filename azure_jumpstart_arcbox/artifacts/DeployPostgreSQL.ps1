...
kubectl exec $pgControllerPodName -n arc -c postgres -- /bin/bash -c "cd /tmp && curl -k -O https://jumpstart.blob.core.windows.net/jumpstartbaks/AdventureWorks2019.sql" 2>&1 | Out-Null
