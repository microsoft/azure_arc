...
kubectl exec $podname -n arc -c postgres -- /bin/bash -c "cd /tmp && curl -k -O https://raw.githubusercontent.com/microsoft/azure_arc/arcbox_data_fix/azure_jumpstart_arcbox/artifacts/AdventureWorks2019.sql" 2>&1 | Out-Null
