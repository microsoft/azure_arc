...
Register-ScheduledTask -TaskName "WinGetLogonScript" -User $adminuser -Trigger $Trigger -CimSession $cimsession -Action $Action -RunLevel "Highest" -Force -Settings $settings
