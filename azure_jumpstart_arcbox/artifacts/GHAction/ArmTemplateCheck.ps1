...
$results = Invoke-Pester -Script @{Path = ".\azure_jumpstart_arcbox\artifacts\GHAction\TestArmTemplate.ps1"; Parameters = @{TemplatePath = "$ArmFile"; Skip = "$ExcludeRules"}} -OutputFormat NUnitXml -OutputFile TEST-arm_template.xml -PassThru
