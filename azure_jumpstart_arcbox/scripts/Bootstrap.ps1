            ...
            Parallel 
                {
                    ...
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/arcbox/azure_jumpstart_arcbox/scripts/settingsTemplate.json" -OutFile "C:\ArcBox\settingsTemplate.json"
