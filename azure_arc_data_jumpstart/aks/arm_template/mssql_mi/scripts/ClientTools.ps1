            ...
            Parallel
                {
                    ...
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/settings_ip/azure_arc_data_jumpstart/aks/arm_template/mssql_mi/scripts/MSSQL_MI_Cleanup.ps1" -OutFile "C:\tmp\MSSQL_MI_Cleanup.ps1"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/settings_ip/azure_arc_data_jumpstart/aks/arm_template/mssql_mi/scripts/MSSQL_MI_Deploy.ps1" -OutFile "C:\tmp\MSSQL_MI_Deploy.ps1"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/settings_ip/azure_arc_data_jumpstart/aks/arm_template/mssql_mi/settings_template.json" -OutFile "C:\tmp\settings_template.json"
                }
        }
...
kubectl describe svc $env:MSSQL_MI_NAME-external-svc -n $env:ARC_DC_NAME | Select-String "LoadBalancer Ingress" | Tee-Object "C:\tmp\sql_instance_list.txt"
$sqlfile = "C:\tmp\sql_instance_list.txt"
$split = $sqlstring.split(" ") | Tee-Object "C:\tmp\sql_instance_list.txt"
(Get-Content $sqlfile | Select-Object -Skip 6) | Set-Content $sqlfile
