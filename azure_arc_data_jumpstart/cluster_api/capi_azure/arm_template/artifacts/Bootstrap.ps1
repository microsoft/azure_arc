            ...
            Parallel 
                {
                    ...
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/capi_data_connected/azure_arc_data_jumpstart/cluster_api/capi_azure/arm_template/artifacts/settingsTemplate.json" -OutFile "C:\Temp\settingsTemplate.json"
                    Invoke-WebRequest "https://aka.ms/azdata-msi" -OutFile "C:\Temp\AZDataCLI.msi"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/capi_data_connected/azure_arc_data_jumpstart/cluster_api/capi_azure/arm_template/artifacts/DataServicesLogonScript.ps1" -OutFile "C:\Temp\DataServicesLogonScript.ps1"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/capi_data_connected/azure_arc_data_jumpstart/cluster_api/capi_azure/arm_template/artifacts/DeploySQLMI.ps1" -OutFile "C:\Temp\DeploySQLMI.ps1"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/capi_data_connected/azure_arc_data_jumpstart/cluster_api/capi_azure/arm_template/artifacts/DeployPostgreSQL.ps1" -OutFile "C:\Temp\DeployPostgreSQL.ps1"                    
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/capi_data_connected/azure_arc_data_jumpstart/cluster_api/capi_azure/arm_template/artifacts/capiStorageClass.yaml" -OutFile "C:\Temp\capiStorageClass.yaml"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/capi_data_connected/azure_arc_data_jumpstart/cluster_api/capi_azure/arm_template/artifacts/dataController.json" -OutFile "C:\Temp\dataController.json"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/capi_data_connected/azure_arc_data_jumpstart/cluster_api/capi_azure/arm_template/artifacts/dataController.parameters.json" -OutFile "C:\Temp\dataController.parameters.json"
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/capi_data_connected/azure_arc_data_jumpstart/cluster_api/capi_azure/arm_template/artifacts/SQLMI.json" -OutFile "C:\Temp\SQLMI.json"
