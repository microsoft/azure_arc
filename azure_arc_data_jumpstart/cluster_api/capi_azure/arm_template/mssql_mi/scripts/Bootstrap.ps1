            ...
            Parallel 
                {
                    ...
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/capi_data_sqlmi/azure_arc_data_jumpstart/cluster_api/capi_azure/arm_template/mssql_mi/scripts/wallpaper.png" -OutFile "C:\Temp\wallpaper.png"
                }
        }
