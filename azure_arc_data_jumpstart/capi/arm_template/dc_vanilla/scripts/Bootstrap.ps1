            ...
            Parallel 
                {
                    ...
                    Invoke-WebRequest "https://raw.githubusercontent.com/microsoft/azure_arc/capi_data_vanilla/azure_arc_data_jumpstart/capi/arm_template/dc_vanilla/scripts/settingsTemplate.json" -OutFile "C:\Temp\settingsTemplate.json"
