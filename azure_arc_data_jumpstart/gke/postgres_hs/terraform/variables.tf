...
variable "POSTGRES_SERVICE_TYPE" {
  description = "Choose how PostgreSQL service is accessed through Kubernetes networking interface <ClusterIP, LoadBalancer, NodePort>"
