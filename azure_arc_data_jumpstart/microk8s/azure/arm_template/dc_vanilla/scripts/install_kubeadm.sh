...
# Installing kubeadm
wget -q -O CreateSingleNodeCluster.sh https://raw.githubusercontent.com/mdrakiburrahman/kubeadm-multipass/main/CreateSingleNodeCluster.sh
chmod +x CreateSingleNodeCluster.sh
./CreateSingleNodeCluster.sh
