...
# Installing tools
$chocolateyAppList = "azure-cli,az.powershell,kubernetes-cli,aws-iam-authenticator,vcredist140,kubernetes-helm,vscode,putty.install,microsoft-edge,azcopy10,grep,dotnetcore-3.1-sdk"
