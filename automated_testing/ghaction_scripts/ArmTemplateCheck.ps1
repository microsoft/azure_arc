...
$results = Invoke-Pester -Script @{Path = ".\automated_testing\ghaction_scripts\TestArmTemplate.ps1"; Parameters = @{TemplatePath = "$ArmFile"; Skip = "$ExcludeRules"}} -OutputFormat NUnitXml -OutputFile TEST-arm_template.xml -PassThru
