...
The following README will guide you on how to use the provided [Terraform](https://www.terraform.io/) plan to deploy an OCI Virtual Machine and connect it as an Azure Arc enabled server resource. 
...
* [Install or update Azure CLI to version 2.17.1 and above](https://docs.microsoft.com/en-us/cli/azure/install-azure-cli?view=azure-cli-latest). Use the below command to check your current installed version.
...
* Get the public IP of the OCI Virtual Machine instance by running ```terraform output```
...
* Run the following command
    ...
    ```shell
    sudo azcmagent connect --service-principal-id $TF_VAR_client_id \
    --service-principal-secret $TF_VAR_client_secret \
    --resource-group "Arc-OCI-Demo" \
