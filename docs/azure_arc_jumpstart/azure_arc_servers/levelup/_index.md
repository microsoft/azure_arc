...
|---------------|---------------|---------------|
|**Labs Infrastructure and pre-requisites** | x minutes | Seif Bassem |
...
|**Deploy Azure Monitor using AMA through Azure Policy** | x minutes | Basim Majeed |
...
|**(Optional) Enforce governance across your Azure Arc-enabled servers using Azure Policy** | x minutes | Basim Majeed |
|**(Optional) Manage the Windows operating system of your Arc-enabled servers using Windows Admin Center (Preview)** | x minutes | Basim Majeed |
|**(Optional) Query and inventory your Azure Arc-enabled servers using Azure Resource Graph** | x minutes | Basim Majeed |
