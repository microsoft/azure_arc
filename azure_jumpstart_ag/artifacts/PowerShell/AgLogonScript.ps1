...
# Importing fuctions
#####################################################################
Import-Module "$AgPowerShellDir\common.psm1" -Force -Global
Import-Module "$AgPowerShellDir\retail.psm1" -Force -Global
Import-Module "$AgPowerShellDir\manufacturing.psm1" -Force -Global
