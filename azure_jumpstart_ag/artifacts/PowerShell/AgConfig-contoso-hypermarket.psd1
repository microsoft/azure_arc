@{
    ...
    Monitoring              = @{
        ...
        Dashboards = @{
            ...
            "custom"      = @('node-exporter-full','cluster-global', 'cluster-workloads', 'cluster-pods') # Dashboards from https://github.com/microsoft/azure_arc/tree/main/azure_jumpstart_ag/artifacts/monitoring
        }
    }
